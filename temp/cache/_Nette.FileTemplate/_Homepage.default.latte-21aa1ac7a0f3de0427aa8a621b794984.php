<?php //netteCache[01]000349a:2:{s:4:"time";s:21:"0.03460300 1302357211";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:60:"/var/www/evovin/sandbox/app/templates/Homepage/default.latte";i:2;i:1299802972;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"7616569 released on 2011-03-10";}}}?><?php

// source file: /var/www/evovin/sandbox/app/templates/Homepage/default.latte

?><?php
$_l = NLatteMacros::initRuntime($template, NULL, 'cf0gv7qghq'); unset($_extends);


//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb71afb776c_content')) { function _lbb71afb776c_content($_l, $_args) { extract($_args)
?>
<div id="wrapper">
	<div id="logo"></div>
	...
	<ol>
		...
		<p>Manage your database using pre-installed tool <a href="<?php echo NTemplateHelpers::escapeHtml($basePath) ?>/adminer/">Adminer</a> with an easy to use GUI.<p>
	...
	<h2>We hope you enjoy this framework! <img src="<?php echo NTemplateHelpers::escapeHtml($basePath) ?>/images/nette-powered2.gif" width="80" height="15" alt="Nette Framework powered" /></h2>

	<ul id="environment">
		<li>PHP <?php echo NTemplateHelpers::escapeHtml(PHP_VERSION) ?></li><?php if (isset($_SERVER['SERVER_SOFTWARE'])): ?>
		<li>Server <?php echo NTemplateHelpers::escapeHtml($_SERVER['SERVER_SOFTWARE']) ?></li>
<?php endif ?>
		<li>Nette Framework <?php echo NTemplateHelpers::escapeHtml(NFramework::VERSION) ?></li>
	</ul>
</div>
<?php
}}
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lbedcfacec37_head')) { function _lbedcfacec37_head($_l, $_args) { extract($_args)
?>
<style>
	html {
